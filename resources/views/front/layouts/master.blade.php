...
<head>
    ...
    <link rel="stylesheet" href="{{asset('resources/lib/themify-icons/themify-icons.css')}}" />
...
<body id="homepage" data-api="{{ url('api')  }}" data-max-width=1800 >
<!-- BEGIN PRELOADING -->
...
<div class="row" id="route-app">
                ...
                <div class="row menu-content hide-on-med-and-down">
                    <div class="left-box ">
                        <div class="header-logo ">
                            <a href="{{url('/')}}" class="nav-logo center-align valign-wrappe">
                    ...
                    <div class="right-box">
                        <div class="row">
                            ...
                            <div class="col s6">
                                <ul class="right">
                                    <li>
                                        <a href="{{ url('') }}"  @click.stop.prevent="loadView('')">
                                            {{ __('Home') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('login') }}"  @click.stop.prevent="loadView('login')">
                                            {{ __('Login/Register') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('network') }}"  @click.stop.prevent="loadView('network')">
                                            {{ __('Raoviec Network') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('about-us') }}"  @click.stop.prevent="loadView('about-us')">
                                            {{ __("About us") }}
                                        </a>
                                    </li>
                                    <li>
                                        <a href="{{ url('contact') }}"  @click.stop.prevent="loadView('contact')">
                                            {{ __('Contact') }}
                                        </a>
                                    </li>
                                    <li>
    ...
    <nav>
        ...
        <ul id="nav-mobile-category" class="side-nav">
            ...
            <li>
                <a href="{{ url('jobs') }}"  @click.stop.prevent="loadView('jobs')">
        ...
        <ul id="nav-mobile-account" class="side-nav">
            ...
            <li>
                <a href="{{ url('/logout') }}" @click.stop.prevent="logout" >
...
<!-- Custom script -->
<script src="{{ asset('resources/lib/vue/vue.js')}}"></script>
<script src="{{ asset('resources/lib/vue/vue-form.js')}}"></script>
