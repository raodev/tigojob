...
<head>
    ...
    <!-- CSS  -->
    <link rel="stylesheet" href="{{asset('resources/lib/font-awesome/web-fonts-with-css/css/fontawesome-all.css')}}">
    <link rel="stylesheet" href="{{asset('resources/css/materialize.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('resources/lib/owlcarousel/assets/owl.theme.default.min.css')}}">
    <!-- Slick CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('resources/lib/slick/slick/slick.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('resources/lib/slick/slick/slick-theme.css')}}">
    <!-- Magnific Popup core CSS file -->
    <link rel="stylesheet" href="{{asset('resources/lib/Magnific-Popup-master/dist/magnific-popup.css')}}">
</head>
<body id="homepage">
<!-- BEGIN PRELOADING -->
...
<header id="header">
    <div class="nav-wrapper container">
        <div class="header-logo">
            <a href="#" class="nav-logo"><i class="fab fa-envira"></i> GroMart</a>
        </div>
            ...
            <ul class="collapsible collapsible-accordion">
                <li>
                    ...
                    <div class="collapsible-body">
                        <ul>
                            <li>
                                <a class="waves-effect waves-blue" href="product-list.html"><i class="fas fa-angle-right"></i>Cabbage</a>
                            </li>
                            <li>
                                <a class="waves-effect waves-blue" href="product-list.html"><i class="fas fa-angle-right"></i>Corn</a>
                            </li>
                            <li>
                                <a class="waves-effect waves-blue" href="product-list.html"><i class="fas fa-angle-right"></i>Potato</a>
                            </li>
                            <li>
                                <a class="waves-effect waves-blue" href="product-list.html"><i class="fas fa-angle-right"></i>Carrot</a>
                            </li>
                        </ul>
                    </div>
                </li>
    ...
    <ul id="nav-mobile-account" class="side-nav">
        <li class="profile">
            <div class="li-profile-info">
                <img src="{{asset('resources/img/profile.jpg')}}" alt="profile">
                <h2>Jane Doe</h2>
            ...
            <div class="bg-profile-li" style="background-image: url({{asset('resources/img/bg-profile.jpg')}});">
            </div>
        </li>
        <li>
...
<div class="main-slider" data-indicators="true">
    <div class="carousel carousel-slider " data-indicators="true">
        <a class="carousel-item"><img src="{{asset('resources/img/slide2.jpg')}}" alt="slider"></a>
        <a class="carousel-item"><img src="{{asset('resources/img/slide3.jpg')}}" alt="slider"></a>
    </div>
</div>
<!-- END MAIN SLIDER -->
<!-- CATEGORY -->
        ...
        <div class="row icon-service">
                ...
                <div class="content">
                    <div class="in-content">
                        <div class="in-in-content">
                            <img src="{{asset('resources/img/c-diet.png')}}" alt="category">
                            <h5>Best<br>Promo</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="col s4 m4 l2">
                <div class="content">
                    <div class="in-content">
                        <div class="in-in-content">
                            <img src="{{asset('resources/img/c-groceries.png')}}" alt="category">
                            <h5>Best<br>Selling</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col s4 m4 l2">
                <div class="content">
                    <div class="in-content">
                        <div class="in-in-content">
                            <img src="{{asset('resources/img/c-apple.png')}}" alt="category">
                            <h5>Fruit</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="col s4 m4 l2">
                <div class="content">
                    <div class="in-content">
                        <div class="in-in-content">
                            <img src="{{asset('resources/img/c-asparagus.png')}}" alt="category">
                            <h5>New Product</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="col s4 m4 l2">
                <div class="content">
                    <div class="in-content">
                        <div class="in-in-content">
                            <img src="{{asset('resources/img/c-salad.png')}}" alt="category">
                            <h5>Vegetable</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="col s4 m4 l2">
                <div class="content">
                    <div class="in-content">
                        <div class="in-in-content">
                            <img src="{{asset('resources/img/c-turkey.png')}}" alt="category">
                            <h5>Fast Food</h5>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col s12">
                <div class="list-tag-word">
                    <a class="tag-word">Cabbage</a>
                    <a class="tag-word">Broccoli</a>
                    <a class="tag-word">Carrot</a>
                    <a class="tag-word">Potato</a>
                    <a class="tag-word">Rice</a>
                    <a class="tag-word">Salad</a>
                    <a class="tag-word">Fish</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="box-product">
                                <div class="bp-top">
                                    <div class="product-list-img">
                                        <div class="pli-one">
                                            <div class="pli-two">
                                                <img src="{{asset('resources/img/broccoli.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                    <h5><a href="#">Broccoli</a></h5>
                            ...
                            <div class="box-product">
                                <div class="bp-top">
                                    <div class="product-list-img">
                                        <div class="pli-one">
                                            <div class="pli-two">
                                                <img src="{{asset('resources/img/cabbage_PNG8821.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box-product">
                                <div class="bp-top">
                                    <div class="product-list-img">
                                        <div class="pli-one">
                                            <div class="pli-two">
                                                <img src="{{asset('resources/img/carrot_PNG4978.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box-product">
                                <div class="bp-top">
                                    <div class="product-list-img">
                                        <div class="pli-one">
                                            <div class="pli-two">
                                                <img src="{{asset('resources/img/corn_PNG5284.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                    <h5><a href="#">Corn</a></h5>
                            ...
                            <div class="box-product">
                                <div class="bp-top">
                                    <div class="product-list-img">
                                        <div class="pli-one">
                                            <div class="pli-two">
                                                <img src="{{asset('resources/img/pineapple_PNG2759.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                    <h5><a href="#">Pinneapple</a></h5>
                            ...
                            <div class="box-product">
                                <div class="bp-top">
                                    <div class="product-list-img">
                                        <div class="pli-one">
                                            <div class="pli-two">
                                                <img src="{{asset('resources/img/blackberry_PNG46.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box-product">
                                <div class="bp-top">
                                    <div class="product-list-img">
                                        <div class="pli-one">
                                            <div class="pli-two">
                                                <img src="{{asset('resources/img/potato_PNG7093.jpg')}}" alt="img">
                                            </div>
                                        </div>
                                    </div>
...
<div class="section promo">
    <div class="container">
        <div class="col s12">
            <img src="{{asset('resources/img/promo.jpg')}}" alt="promo">
        </div>
    </div>
</div>
<!-- END PROMO -->
<!-- VEGETABLE -->
<div class="section product-item vegetable-list-homepage">
    <div class="container">
        <div class="row row-title">
            <div class="col s12">
                <div class="section-title">
                    <span class="theme-secondary-color">VEGETABLE</span>
                </div>
            </div>
        </div>
        <div class="row slick-product">
    ...
    <div class="testimonial-wrap">
        <div class="container">
            <div class="row">
                <div class="col s12">
                    <div class="section-title">
                        <span class="theme-secondary-color">CUSTOMER</span> REVIEWS
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <div id="testimonial-item" class="owl-carousel">
                            ...
                            <div class="item-testimonial">
                                <div class="client-info">
                                    <div class="client-img">
                                        <img src="{{asset('resources/img/profile2.jpg')}}" alt="profile">
                                    </div>
                                    <div class="rating">
                        ...
                        <div class="item">
                            <div class="item-testimonial">
                                <div class="client-info">
                                    <div class="client-img">
                                        <img src="{{asset('resources/img/profile3.jpg')}}" alt="profile">
                                    </div>
                                    <div class="rating">
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
                        ...
                        <div class="item">
                            <div class="item-testimonial">
                                <div class="client-info">
                                    <div class="client-img">
                                        <img src="{{asset('resources/img/profile4.jpg')}}" alt="profile">
                                    </div>
                                    <div class="rating">
                                        <span class="fa fa-star"></span>
                                        <span class="fa fa-star"></span>
...
<div class="section subscribe">
    ...
    <div class="bg-subscribe" style="background-image: url({{asset('resources/img/bg-profile.jpg')}}); ">
    </div>
</div>
<!-- END SUBSCRIBE -->
<!-- FOOTER  -->
...
<script src="{{ asset('resources/js/materialize.min.js')}}"></script>
<!-- Owl carousel -->
<script src="{{ asset('resources/lib/owlcarousel/owl.carousel.min.js')}}'"></script>
<!-- Magnific Popup core JS file -->
<script src="{{ asset('resources/lib/Magnific-Popup-master/dist/jquery.magnific-popup.js')}}"></script>
<!-- Slick JS -->
<script src="{{ asset('resources/lib/slick/slick/slick.min.js')}}"></script>
<!-- Custom script -->
