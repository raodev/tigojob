...
@section('content')
    <div id="page-content" class="container-fluid p-t-30" data-title="{{ __('About us') }}">
        <div class="row">
            <div class="col s12">
                ...
                <div class="col s12 m4">
                    <div class="input-field col s12">
                        ...
                        <label>
                            {{ __('Choose your location filter') }}
                        </label>
                    </div>
                </div>
                <div class="col s12 m4">
                ...
                <div class="col s12 job-wrapper">
                    <div class="col s12 job-item">
                        <div class="job-thumbnail">
                            <div class="image-box">
                                <img src="{{asset('resources/img/corn_PNG5284.jpg')}}" class="img-fluid" alt="">
                            </div>
                        </div>
